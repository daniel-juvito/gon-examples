...
- [v1 scope](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/v1-scope.md)
- [.gna spec](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/gna-spec-v1.md)
- [Return-value contracts (v1.1)](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/rfc-return-value-contracts.md)
- [Field contracts (v1.2)](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/rfc-field-contracts.md)
- [Interface semantics (v1.4)](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/rfc-interface-semantics.md)
- [Ecosystem contract expansion (v1.5)](https://github.com/daniel-juvito/gon/blob/v1.5.1/docs/rfc-ecosystem-contract-expansion.md)
